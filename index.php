      ...
      <div class="icon m-8">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            <center>
              <li><a class="dropdown-item" href="chat_pqrs.html">Chat</a></li>
              <li><a class="dropdown-item" href="llamanos.html">Llamada</a></li>
        ...
        <div class="card" style="width: 17rem;">
          <div class="card-body">
            ...
            <div class="d-grid gap-2">  
              <a class="btn btn-danger" href="producto_carnicos.html" aria-hidden="true">Ir a categoria</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-3">   
        <div class="card" style="width: 17rem;">
          <div class="card-body">
            ...
            <div class="d-grid gap-2">
              <a class="btn btn-danger" href="productos_de_pollo.html" aria-hidden="true">Ir a categoria</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-3">  
        <div class="card" style="width: 17rem;">
          <div class="card-body">
            ...
            <div class="d-grid gap-2">
              <a class="btn btn-danger" href="productos_de_cerdo.html" aria-hidden="true">Ir a categoria</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-3">  
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            ...
            <div class="d-grid gap-2">
              <a class="btn btn-danger" href="productos_de_chorizo.html" aria-hidden="true">Ir a categoria</a>
            </div>
          </div>
        </div>
      </div>

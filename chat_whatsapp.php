...
<head>
    ...
    <title>Cuéntanos que servicio necesitas</title>
    ...
    <div class="container col-sm-4 col-md-4 col-lg-4 col-xl-3">
        ...
        <div class="card mt-5">
            <div class="card-header">
                <h3><i class="text-danger me-3 " id="card" aria-hidden="true"> Cuéntanos que servicio necesitas</i></h3>
            </div>
            <br>
            <center>
                ...
                <a href="mensajes.html" class="btn btn-danger">Volver atras</a>
            </center>
            <br>
        </div>
    </div>

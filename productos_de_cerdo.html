...
<head>
    ...
    <title>productos_de_cerdo</title>
...
<body>
  ...
  <div class="container">
    <p><h1 class="text-center mt-5">Productos de Cerdo</h1></p>
    <div class="row">
      <div class="col-3 g-3">    
        <div class="card" style="width: 17rem;">
          <div class="card-body">
            <img src="imagenes/chuletas_de_lomo.jpg" class="card-img-top" alt="ProductoCarne"  width="500" height="200" >
            <h5 class="card-title mt-4">Chuleta de lomo</h5>
            <p class="card-text">Precio por libra $11.000</p>
            <p class="card-text"><i>Cod.3939</i></p>
      ...
      <div class="col-3 g-3">    
        <div class="card" style="width: 17rem;">
          <div class="card-body">
            <img src="imagenes/cinta_de_lomo.jpg" class="card-img-top" alt="ProductoCarne"  width="500" height="200">
            <h5 class="card-title mt-4">Cinta de Lomo</h5>
            <p class="card-text">Precio por libra $9.000</p>
            <p class="card-text"><i>Cod.9949</i></p>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
      ...
      <div class="col-3 g-3"> 
        <div class="card" style="width: 17rem;">
          <div class="card-body">
            <img src="imagenes/manitas_de_cerdo.jpg" class="card-img-top" alt="ProductoCarne"  width="500" height="200">
            <h5 class="card-title mt-4">Manitas de Cerdo</h5>
            <p class="card-text">Precio por libra $7.000</p>
            <p class="card-text"><i>Cod.9844</i></p>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="col-3 g-3"> 
        <div class="card" style="width: 17rem;">
          <div class="card-body">
            <img src="imagenes/panceta_de_cerdo.jpg" class="card-img-top" alt="ProductoCarne"  width="500" height="200">
            <h5 class="card-title mt-4">Panceta de cerdo</h5>
            <p class="card-text">Precio por libra $8.000</p>
            <p class="card-text"><i>Cod.2569</i></p>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star text-danger" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>

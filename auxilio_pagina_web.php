    ...
    <div class="container col-sm-4 col-md-4 col-lg-4 col-xl-3">
        ...
        <div class="card mt-5">
            ...
            <div class="card-body mt-3 text-left">
                <h5 class="card-tittle"> Necesito un auxilio en la página web</h5>
                <hr>
                <h5 class="card-tittle"> Puede contactar con nosotros a través de nuestra línea nacional o teléfono móvil</h5>
                <hr>
                <h5 class="card-tittle"> En bogotá</h5>
                <center>
                    <h6>60(1) 246 80 13</h6>
                </center>
                <hr>
                <div class="card" style="width: 16rem;">
                    <ul class="list-group list-group-flush">
                        ...
                        </svg> 57 9246 80 13 57</li>
                        <li class="list-group-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at" viewBox="0 0 16 16">
                        ...
                        </svg> contactodigital@asagosas.com</li>
                    </ul>
                </div>
                <br>
                <center>

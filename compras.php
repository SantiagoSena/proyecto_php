...
<body>
  ...
  <div class="col-md-10 p-5 pt-5">
      <h3><i class="fa fa-book me-2" aria-hidden="true"></i> Listado Compras</h3>
      <hr>
      ...
      <div class="card text-center col-sm-12 col-md-12 col-lg-10 col-xl-10">
        <div class="card-header">
          <ul class="nav nav-pills card-header-pills">
            <li class="nav-item">
              <h4><i class="fa fa-people me-2" aria-hidden="true"></i>Compras</h4>
            </li>
          </ul>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <p class="card-text">Agregar una nueva Compra</p>
                <hr>
